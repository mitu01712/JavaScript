...
if(5 != '5'){console.log(true)}else{console.log(false)}// = it just comparison with value
if(5 !== '5'){console.log(true)}else{console.log(false)}// == mean comparison with value and also data type
if(5 < 10) {console.log(true)}else{console.log(false)}
